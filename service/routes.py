...
def create_accounts():
    """Creates an Account from the data in the body that is posted"""
...
def get_accounts(account_id):
    ...
    if not account:
        msg = f"Account with id [{account_id}] could not be found."
...
def update_accounts(account_id):
    """Update an Account based on the posted data"""
